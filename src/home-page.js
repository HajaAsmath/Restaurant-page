...
export default function homePage() {
    let home = domUtils.createDiv('home-content', 'content');
    let logoDiv = domUtils.createDiv('logo');
    let logoImg = domUtils.createImg(logo,'logoImage');
    logoDiv.appendChild(logoImg);

    let introDiv = domUtils.createDiv('intro-container');
    let borderImg = domUtils.createImg(border, 'border');
    let borderImg1 = domUtils.createImg(border, 'border');
    let introPara = domUtils.createPara(null, 'intro');
    let introPara2 = domUtils.createPara(null, 'intro');
